...
const NAV = [
  { id: 'upload'     as Step, icon: IconCreate,      label: 'Create'     },
  { id: 'customize'  as Step, icon: IconProjects,    label: 'Customize'  },
  { id: 'transcript' as Step, icon: IconTranscript,  label: 'Transcript' },
  { id: 'export'     as Step, icon: IconExport,      label: 'Export'     },
]

export default function Sidebar({ step, onNav }: Props) {
  return (
    <aside
      style={{
        width: 220,
