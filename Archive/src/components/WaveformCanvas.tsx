...
function drawSubtitle(dc: DC, defaultBoxY: number) {
  if (!dc.activeSeg) return
  const boxY = dc.subtitleYPct !== null ? dc.H * dc.subtitleYPct : defaultBoxY
...
export default function WaveformCanvas({
  ...
  }, [color, bgColor, waveStyle, title, segments, fontSize, fontName, karaokeEnabled, karaokeColor, layoutTemplate, subtitleColor, subtitleYPct, zones])
